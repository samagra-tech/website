import"../chunks/CWj6FrbW.js";import"../chunks/Cr1QaZZ0.js";import{a4 as f,af as y,ah as e,al as w,ag as v,a7 as b,ai as t,b as x,ak as c,aj as a}from"../chunks/CNydOz30.js";import{s as d}from"../chunks/C8wrggly.js";import{i as O}from"../chunks/_uus0BoM.js";/* empty css                */const A=""+new URL("../assets/ai-ocr-hero.CepStYr9.jpg",import.meta.url).href;var C=y(`<article class="blog-post"><header><h1>From Paper to Structured Data: GenAI Meets OCR</h1> <div class="metadata">on <time></time> <span>by Samagra Tech Team</span></div></header> <div class="content"><div class="tldr"><p>We built a GenAI-powered service that combines OCR with contextual
      ...
      requirements.</p> <ul><li><strong>Build time:</strong> 1 month from design to deployment</li> <li><strong>Accuracy:</strong> ~95% in pilot tests</li> <li><strong>Impact:</strong> Reduced manual data entry effort and enabled faster
        ...
        for broader rollout</li></ul></div></article>`);function D(h,m){f(m,!1);const o=new Date("2025-09-06"),u=o.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});O();var i=C(),r=t(i),n=e(t(r),2),s=e(t(n));s.textContent=u,c(2),a(n),a(r);var l=e(r,2),p=e(t(l),10);d(p,"src",A),c(18),a(l),a(i),w(g=>d(s,"datetime",g),[()=>o.toISOString()],x),v(h,i),b()}export{D as component};
