import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{p as R,o as G,q as e,v as S,w as z,x as q,y as t,z as C,A as s,B as a}from"../chunks/CInyQLVs.js";import{s as y}from"../chunks/CFlxt8Eu.js";import{i as B}from"../chunks/CdQTAtZ6.js";import{F as n}from"../chunks/Dzvsefeu.js";/* empty css                */import{f as F,a as I,b as P,c as U,d as W}from"../chunks/DoTX0OCW.js";const E=""+new URL("../assets/rag-hero.Cs2Jn_Xm.jpg",import.meta.url).href;var M=G(`<article class="blog-post"><header><h1>Lessons from Building RAG Applications that Actually Work</h1> <div class="metadata">on <time></time> <span>by Sudhakar Rayavaram</span></div></header> <div class="content"><div class="tldr"><p>By 2025, building a Retrieval-Augmented Generation (RAG) system is no
      ...
      the default.</p></div></article>`);function X(v,b){R(b,!1);const h=new Date("2025-09-03"),w=h.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});B();var i=M(),r=t(i),c=e(t(r),2),m=e(t(c));m.textContent=w,s(2),a(c),a(r);var g=e(r,2),u=e(t(g),8);y(u,"src",E);var o=e(u,4),x=t(o);n(x,{icon:F,style:"padding-right: 10px"}),s(),a(o);var l=e(o,4),k=t(l);n(k,{icon:I,style:"padding-right: 10px"}),s(),a(l);var d=e(l,4),_=t(d);n(_,{icon:P,style:"padding-right: 10px"}),s(),a(d);var p=e(d,4),A=t(p);n(A,{icon:U,style:"padding-right: 10px"}),s(),a(p);var f=e(p,4),D=t(f);n(D,{icon:W,style:"padding-right: 10px"}),s(),a(f),s(6),a(g),a(i),S(L=>y(m,"datetime",L),[()=>h.toISOString()],C),z(v,i),q()}export{X as component};
