import"../chunks/CWj6FrbW.js";import"../chunks/69_IOA4Y.js";import{F as G,G as R,H as e,I as S,J as z,K as C,M as t,O as q,P as s,Q as a}from"../chunks/DBIfrNn-.js";import{s as y}from"../chunks/SfRhKYjv.js";import{i as F}from"../chunks/ChkqvMFB.js";import{F as n}from"../chunks/DXNGHpoM.js";import{f as I,a as P,b as B,c as M,d as U}from"../chunks/CkdyB0yD.js";const W=""+new URL("../assets/rag-hero.Cs2Jn_Xm.jpg",import.meta.url).href;var E=R(`<article class="blog-post"><header><h1>Lessons from Building RAG Applications that Actually Work</h1> <div class="metadata">on <time></time> <span>by Sudhakar Rayavaram</span></div></header> <div class="content"><div class="tldr"><p>By 2025, building a Retrieval-Augmented Generation (RAG) system is no
      ...
      the default.</p></div></article>`);function T(v,b){G(b,!1);const h=new Date("2025-09-03"),w=h.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});F();var i=E(),r=t(i),c=e(t(r),2),m=e(t(c));m.textContent=w,s(2),a(c),a(r);var g=e(r,2),u=e(t(g),8);y(u,"src",W);var o=e(u,4),k=t(o);n(k,{icon:I,style:"padding-right: 10px"}),s(),a(o);var l=e(o,4),x=t(l);n(x,{icon:P,style:"padding-right: 10px"}),s(),a(l);var d=e(l,4),_=t(d);n(_,{icon:B,style:"padding-right: 10px"}),s(),a(d);var p=e(d,4),A=t(p);n(A,{icon:M,style:"padding-right: 10px"}),s(),a(p);var f=e(p,4),D=t(f);n(D,{icon:U,style:"padding-right: 10px"}),s(),a(f),s(6),a(g),a(i),S(L=>y(m,"datetime",L),[()=>h.toISOString()],q),z(v,i),C()}export{T as component};
