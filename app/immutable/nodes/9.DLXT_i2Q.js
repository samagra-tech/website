import"../chunks/CWj6FrbW.js";import"../chunks/Dn5ouMhn.js";import{ae as R,ap as G,aq as e,au as S,a as q,ah as z,ar as t,i as C,at as s,as as a}from"../chunks/B_kOCNy5.js";import{s as y}from"../chunks/B5w4xVpO.js";import{i as B}from"../chunks/BuVfeZlF.js";import{F as n,f as F,a as I,b as P,c as U,d as W}from"../chunks/DaX4grpg.js";/* empty css                */const E=""+new URL("../assets/rag-hero.Cs2Jn_Xm.jpg",import.meta.url).href;var M=G(`<article class="blog-post"><header><h1>Lessons from Building RAG Applications that Actually Work</h1> <div class="metadata">on <time></time> <span>by Sudhakar Rayavaram</span></div></header> <div class="content"><div class="tldr"><p>By 2025, building a Retrieval-Augmented Generation (RAG) system is no
      ...
      the default.</p></div></article>`);function V(v,b){R(b,!1);const h=new Date("2025-09-03"),w=h.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});B();var i=M(),r=t(i),c=e(t(r),2),m=e(t(c));m.textContent=w,s(2),a(c),a(r);var g=e(r,2),u=e(t(g),8);y(u,"src",E);var o=e(u,4),k=t(o);n(k,{icon:F,style:"padding-right: 10px"}),s(),a(o);var l=e(o,4),x=t(l);n(x,{icon:I,style:"padding-right: 10px"}),s(),a(l);var d=e(l,4),_=t(d);n(_,{icon:P,style:"padding-right: 10px"}),s(),a(d);var p=e(d,4),A=t(p);n(A,{icon:U,style:"padding-right: 10px"}),s(),a(p);var f=e(p,4),D=t(f);n(D,{icon:W,style:"padding-right: 10px"}),s(),a(f),s(6),a(g),a(i),S(L=>y(m,"datetime",L),[()=>h.toISOString()],C),q(v,i),z()}export{V as component};
