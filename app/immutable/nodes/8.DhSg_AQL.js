import"../chunks/CWj6FrbW.js";import"../chunks/Cr1QaZZ0.js";import{a4 as R,af as G,ah as e,al as S,ag as z,a7 as C,ai as t,b as q,ak as s,aj as a}from"../chunks/CNydOz30.js";import{s as y}from"../chunks/C8wrggly.js";import{i as B}from"../chunks/_uus0BoM.js";import{F as n,f as F,a as I,b as P,c as U,d as W}from"../chunks/C0VB0iap.js";/* empty css                */const j=""+new URL("../assets/rag-hero.Cs2Jn_Xm.jpg",import.meta.url).href;var E=G(`<article class="blog-post"><header><h1>Lessons from Building RAG Applications that Actually Work</h1> <div class="metadata">on <time></time> <span>by Sudhakar Rayavaram</span></div></header> <div class="content"><div class="tldr"><p>By 2025, building a Retrieval-Augmented Generation (RAG) system is no
      ...
      the default.</p></div></article>`);function V(v,b){R(b,!1);const h=new Date("2025-09-03"),w=h.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"});B();var i=E(),r=t(i),c=e(t(r),2),m=e(t(c));m.textContent=w,s(2),a(c),a(r);var g=e(r,2),u=e(t(g),8);y(u,"src",j);var o=e(u,4),k=t(o);n(k,{icon:F,style:"padding-right: 10px"}),s(),a(o);var l=e(o,4),x=t(l);n(x,{icon:I,style:"padding-right: 10px"}),s(),a(l);var d=e(l,4),_=t(d);n(_,{icon:P,style:"padding-right: 10px"}),s(),a(d);var p=e(d,4),A=t(p);n(A,{icon:U,style:"padding-right: 10px"}),s(),a(p);var f=e(p,4),D=t(f);n(D,{icon:W,style:"padding-right: 10px"}),s(),a(f),s(6),a(g),a(i),S(L=>y(m,"datetime",L),[()=>h.toISOString()],q),z(v,i),C()}export{V as component};
